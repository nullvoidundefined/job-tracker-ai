...
describe("jobs repository", () => {
  ...
  describe("createJob", () => {
    it("inserts and returns job", async () => {
      ...
      const result = await jobsRepo.createJob(userId, { title: "Engineer", company: "Acme" });
    ...
    it("throws when insert returns no row", async () => {
      ...
      await expect(jobsRepo.createJob(userId, {})).rejects.toThrow("Insert returned no row");
    });
  });
  ...
  describe("updateJob", () => {
    it("updates and returns job when found", async () => {
      ...
      const result = await jobsRepo.updateJob(jobId, userId, { title: "Senior Engineer" });
  ...
  describe("deleteJob", () => {
    it("returns true when deleted", async () => {
      ...
      expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining("DELETE FROM jobs"), [
        jobId,
        userId,
      ]);
    });
